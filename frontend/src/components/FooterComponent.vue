<script setup>
// Footer ShareHelp - componente visual
const companyInfo = {
  name: 'ShareHelp',
  description: 'Transformando vidas através da generosidade e solidariedade.',
    ...
    <div class="container">
      ...
      <div class="copyright">
        <div class="copyright-text">
          © {{ companyInfo.year }} {{ companyInfo.name }}. Todos os direitos reservados.
        </div>
      </div>
    </div>
  </footer>
